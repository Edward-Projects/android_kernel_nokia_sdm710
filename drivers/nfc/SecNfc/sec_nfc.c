...
//fih test +++++
#ifndef CONFIG_SEC_NFC_IF_I2C
		pr_info("FIH nfc in noooooot define CONFIG_SEC_NFC_IF_I2Ccccccccc  \n");
#else /* CONFIG_SEC_NFC_IF_I2C */
		pr_info("FIH nfc innnnnnn define CONFIG_SEC_NFC_IF_I2Cccccccccc  \n");
#endif

#ifndef CONFIG_SEC_NFC_LDO_EN
		pr_info("FIH nfc in noooooot define CONFIG_SEC_NFC_LDO_ENnnnnnn  \n");
#else /* CONFIG_SEC_NFC_IF_I2C */
		pr_info("FIH nfc innnnnnn define CONFIG_SEC_NFC_LDO_ENnnnnnnnnnn  \n");
#endif
//fih test -----

#ifdef CONFIG_SEC_NFC_LDO_EN
    {
		pr_info("FIH nfc test  \n");
